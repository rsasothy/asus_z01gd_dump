...
stroage_status=`cat /sys/devices/soc/1da4000.ufshc/ufs_status`
stroage_healthA=`cat /sys/devices/soc/1da4000.ufshc/ufs_health_A`
stroage_healthB=`cat /sys/devices/soc/1da4000.ufshc/ufs_health_B`
storage_preEOL=`cat /sys/devices/soc/1da4000.ufshc/ufs_preEOL`
setprop asus.storage.primary.health $ufs_preEOL
setprop asus.storage.primary.status "$storage_preEOL"-"$stroage_healthA"-"$stroage_healthB"-"$stroage_status"

setprop asus.storage.primary.type UFS
storage_size=`cat /sys/devices/soc/1da4000.ufshc/ufs_total_size`
